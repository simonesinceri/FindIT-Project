...
public class RestaurantsBean {
	...
	private int numPeopleRest;
	
	private boolean budget1Rest = false;
	private boolean budget2Rest = false;
	private boolean budget3Rest = false;
	private boolean budget4Rest = false;
	
	private boolean star1Rest = false;
	private boolean star2Rest = false;
	private boolean star3Rest = false;
	private boolean star4Rest = false;
	private boolean star5Rest = false;
	...
	public int getNumPeople() {
		return numPeopleRest;
	}
	
	public void setNumPeople(int numPeople) {
		this.numPeopleRest = numPeople;
	}
